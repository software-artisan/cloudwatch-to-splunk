...
def process_one_log_stream(client, ner, summ_pipeline, group_name, stream_name, first_event_time, last_event_time,
...
try:
  ...
  for ind, row in df.iterrows():
    ...
    try:
        process_one_log_stream(client, ner, summ_pipeline, row['LogGroupName'], row['LogStreamName'],
